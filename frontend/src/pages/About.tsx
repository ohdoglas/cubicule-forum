        ...
        <body className="page-three">
            ...
            <main className="main_content">
                <section className="section_one">
                    ...
                    <p className="feature_text">
                        Whether you're here to learn, share, or trade, Cubicles is designed to empower your creativity, collaboration, and growth. With customizable profiles, gamified activities, and a thriving community, we aim to redefine how professionals and hobbyists connect in the digital age. <br />
                        <Link to={"/register"}>
                ...
                <section className="section_one">
                    ...
                    <p className="feature_text">
                        By using Cubicles, you agree to our Terms of Service. These terms govern your use of our platform, ensuring a safe and fair environment for all users. <br /> Key guidelines include respecting community standards, refraining from unauthorized transactions, and adhering to intellectual property rules. <br /> Breach of terms may result in restricted access or account termination. For full details, visit <Link to={"/terms"}> our terms</Link>.
                    </p>
                </section>
                <section className="section_one">
                    <h1 className="feature_title">
                ...
                <section className="section_one">
                    ...
                    <p className="feature_text">
                        We are dedicated to making Cubicles inclusive for everyone. Our platform supports screen readers, keyboard navigation, and other accessibility tools to ensure a seamless experience for users with disabilities. If you encounter any challenges or have suggestions for improvement, reach out to us at <Link to={"/contact"}>Contact Us</Link>.
                    </p>
                </section>
                <section className="section_one">
                    <h1 className="feature_title">
